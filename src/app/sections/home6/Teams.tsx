...
const TeamSectionTwo = () => {
  return (
    <section className="team-section-two style-two">
        ...
        <div className="row wow fadeInUp">
          <div className="team-column col-xl-12">
            <div className="inner-column">
              {[
                { name: "Lois Lane", role: "Yoga Instructor" },
                { name: "Barbara Gordon", role: "Hatha Yoga" },
                { name: "Harleen Quinzel", role: "Yoga Therapist" },
                { name: "Paula Irving", role: "Awaken Yoga" },
              ].map((member, index) => (
                <div className="team-block-two" key={index}>
                  <div className="inner-box">
                    ...
                    <div
                      ...
                      style={{
                        backgroundImage:
                          "url(/assets/images/resource/team2-1.png)",
                      }}
                    ></div>
                  </div>
                </div>
