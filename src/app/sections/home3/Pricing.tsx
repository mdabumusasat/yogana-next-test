  ...
  return (
    <section className="pricing-section-five style-two">
      <div className="anim-icons">
        <img className="image1 bounce-y" src="/assets/images/resource/flower2.png" alt="" />
        <img className="image2 bounce-x" src="/assets/images/resource/flower3.png" alt="" />
      </div>
      ...
      <div className="outer-box">
        <div className="container">
          ...
          <div className="sec-title text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
            ...
            <h2>
              Discover Your Personalized <br />Yoga Plan
            </h2>
          </div>
