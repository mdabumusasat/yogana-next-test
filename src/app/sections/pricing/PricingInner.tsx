...
export default function PricingSectionFive() {
  ...
  return (
    <section className="pricing-section-five style-three pb-0">
      <div className="anim-icons">
        <img className="image1 bounce-y" src="/assets/images/resource/flower2.png" alt="Image"/>
        <img className="image2 bounce-x" src="/assets/images/resource/flower3.png" alt="Image"/>
      </div>
          ...
          <div className="tabs-style-one wow fadeInUp" data-wow-delay=".4s">
            <ul className="tab-buttons clearfix">
              {tabs.map((tab) => (
                ...
                >
                  <div className="icon">
                    <img className="icon-img" src={tab.icon} alt="Icon" />
                    <svg
                      width="100"
                      height="88"
                      viewBox="0 0 100 88"
