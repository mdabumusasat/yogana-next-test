                        ...
                        <div className="blog-details__left">
                            ...
                            <div className="blog-details__bottom">
                                ...
                                <div className="blog-details__social-list">
                                    <Link href="/news-details"><i className="fa fa-x" /></Link>
                            ...
                            <div className="comment-one">
                                ...
                                <div className="comment-one__single">
                                    ...
                                    <div className="comment-one__content">
                                        ...
                                        <Link href="/news-details" className="theme-btn btn-style-two comment-one__btn"><span className="btn-title">Reply</span></Link>
                                    </div>
                                </div>
                                <div className="comment-one__single">
                                    ...
                                    <form id="contact_form" name="contact_form" action="/" method="get">
                                        <div className="row">
                                            <div className="col-sm-6">
                                                <div className="mb-3">
                                                    <input id='Ename' name="form_name" className="form-control required" type="text" placeholder="Enter Name" />
                                                </div>
                                            </div>
                                            <div className="col-sm-6">
                                                <div className="mb-3">
                                                    <input id='Eemail' name="form_email" className="form-control required email" type="email" placeholder="Enter Email" />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="mb-3">
                        ...
                        <div className="sidebar">
                            <div className="sidebar__single sidebar__search">
                                <form action="#" className="sidebar__search-form">
                                    <input id='Shere' type="search" placeholder="Search here" />
                            ...
                            <div className="sidebar__single sidebar__post">
                                ...
                                <ul className="sidebar__post-list list-unstyled">
                                    <li>
                                        <div className="sidebar__post-image"><img src="/assets/images/resource/blog1-1.jpg" alt="Image" /></div>
                                        <div className="sidebar__post-content">
                                            <h3>
                                                <span className="sidebar__post-content-meta"><i className="fas fa-user-circle" />Admin</span>
                                                <Link href="/news-details">How Scale Your Business Without Losing Quality</Link>
                                            </h3>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="sidebar__post-image"><img src="/assets/images/resource/blog1-2.jpg" alt="Image" /></div>
                                        <div className="sidebar__post-content">
                                            <h3>
                                                <span className="sidebar__post-content-meta"><i className="fas fa-user-circle" />Admin</span>
                                                <Link href="/news-details">Why Networking is Crucial for Business Growth</Link>
                                            </h3>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="sidebar__post-image"><img src="/assets/images/resource/blog1-3.jpg" alt="Image" /></div>
                                        <div className="sidebar__post-content">
                                            <h3>
                                                <span className="sidebar__post-content-meta"><i className="fas fa-user-circle" />Admin</span>
                                                <Link href="/news-details">10 Proven Strategies to Scale</Link>
                                            </h3>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div className="sidebar__single sidebar__category">
                                ...
                                <ul className="sidebar__category-list list-unstyled">
                                    <li><Link href="/news-details">Customer Engagement<span className="icon-right-arrow" /></Link> </li>
                                    <li className="active"><Link href="/news-details">Entrepreneurship<span className="icon-right-arrow" /></Link></li>
                                    <li><Link href="/news-details">Finance<span className="icon-right-arrow" /></Link> </li>
                                    <li><Link href="/news-details">Investment<span className="icon-right-arrow" /></Link> </li>
                                    <li><Link href="/news-details">Management<span className="icon-right-arrow" /></Link> </li>
                                </ul>
                            </div>
